  ...
  const renderOrderList = () => {
    if (orders.length > 0) {
      ...
      return orders.map((order, index) => {
        ...
        return (
          <div key={index} className="bg-orange-200 bg-opacity-50 my-5 p-5 md:rounded-xl">
  ...
  return (
    <div className="flex flex-col">
      <div className="pb-4 md:px-16">
        <span className="text-xl ml-5 md:ml-0 md:text-2xl pb-1 border-b-2 border-primary-100">Your past orders:</span>
        {renderOrderList()}
      </div>
    </div>
  )
